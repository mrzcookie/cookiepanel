...
function SidebarProvider({
	...
	const setOpen = useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// Persist the open state across reloads. The Cookie Store API replaces
			// a raw `document.cookie` write; where it's unavailable the write is
			// simply skipped (nothing reads this cookie server-side yet).
