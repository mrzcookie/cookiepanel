...
const Monaco = lazy(async () => {
	...
	// "The Console" editor themes: cool-ink surface, red accent + semantic syntax,
	...
	monaco.editor.defineTheme("console-dark", {
		...
		colors: {
			...
			"editor.selectionBackground": "#5a2824",
			"editor.lineHighlightBackground": "#12151c",
			"editorCursor.foreground": "#f0564a",
	...
	monaco.editor.defineTheme("console-light", {
		...
		colors: {
			...
			"editor.selectionBackground": "#f6d2cc",
			"editor.lineHighlightBackground": "#e9ebf0",
			"editorCursor.foreground": "#cf352c",
			focusBorder: "#cf352c",
			...
			"editorSuggestWidget.selectedBackground": "#f6d2cc",
			"editorSuggestWidget.highlightForeground": "#bf2f26",
			...
			"list.focusBackground": "#f6d2cc",
			"list.activeSelectionBackground": "#f6d2cc",
			"list.highlightForeground": "#bf2f26",
			"menu.background": "#ffffff",
			"menu.foreground": "#1f242e",
			"menu.selectionBackground": "#f6d2cc",
		},
	});
