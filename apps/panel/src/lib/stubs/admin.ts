...
export const ADMIN_NODES: AdminNode[] = [
	...
	node({
		...
		name: "atlas",
		fqdn: "atlas.acme.raptorpanel.net",
		managed: true,
	...
	node({
		...
		name: "valhalla",
		fqdn: "valhalla.acme.raptorpanel.net",
		managed: true,
	...
	node({
		...
		name: "nimbus",
		fqdn: "nimbus.acme.raptorpanel.net",
		managed: true,
	...
	node({
		...
		name: "orion",
		fqdn: "orion.acme.raptorpanel.net",
		managed: true,
		status: "unhealthy",
	...
	node({
		...
		name: "eu-west-01",
		fqdn: "eu-west-01.northwind.raptorpanel.net",
		managed: true,
	...
	node({
		...
		name: "pf-1",
		fqdn: "pf-1.pixelforge.raptorpanel.net",
		managed: true,
		publicIp: "192.0.2.30",
	...
	node({
		...
		name: "pf-3",
		fqdn: "pf-3.pixelforge.raptorpanel.net",
		managed: true,
		status: "pending",
		publicIp: null,
		os: null,
...
export const SUBDOMAINS: Subdomain[] = [
	{
		...
		hostname: "atlas.acme.raptorpanel.net",
		recordType: "A",
		target: "203.0.113.10",
		status: "active",
	...
	},
	{
		...
		hostname: "valhalla.acme.raptorpanel.net",
		recordType: "A",
		target: "203.0.113.11",
		status: "active",
	...
	},
	{
		...
		hostname: "nimbus.acme.raptorpanel.net",
		recordType: "A",
		target: "203.0.113.12",
		status: "active",
	...
	},
	{
		...
		hostname: "orion.acme.raptorpanel.net",
		recordType: "A",
		target: "203.0.113.13",
		status: "error",
	...
	},
	{
		...
		hostname: "eu-west-01.northwind.raptorpanel.net",
		recordType: "A",
	...
	},
	{
		...
		hostname: "pf-1.pixelforge.raptorpanel.net",
		recordType: "A",
		target: "192.0.2.30",
		status: "active",
	...
	},
	{
		...
		hostname: "pf-3.pixelforge.raptorpanel.net",
		recordType: "A",
		target: "192.0.2.32",
		status: "pending",
