...
export const ALLOCATIONS: AllocationRow[] = [
	...
	// Database servers — each DB's primary bind. Internal-facing, so these are
	// not opened in the host firewall (unlike the public game-server ports).
	{
		id: "a1100005-0000-4a00-8a00-000000005432",
		nodeId: NODE_ID.atlas,
		ip: "0.0.0.0",
		port: 5432,
		protocol: "tcp",
		serverId: "1a2b3c4d-0001-4a00-8a00-000000005432",
		serverName: "App Database",
	},
	{
		id: "b2200004-0000-4b00-8b00-000000006379",
		nodeId: NODE_ID.valhalla,
		ip: "0.0.0.0",
		port: 6379,
		protocol: "tcp",
		serverId: "3c4d5e6f-0003-4c00-8c00-000000006379",
		serverName: "Session Cache",
	},
	{
		id: "c3300005-0000-4c00-8c00-000000003306",
		nodeId: NODE_ID.orion,
		ip: "0.0.0.0",
		port: 3306,
		protocol: "tcp",
		serverId: "2b3c4d5e-0002-4b00-8b00-000000003306",
		serverName: "Store DB",
	},
	{
		id: "c3300006-0000-4c00-8c00-000000027017",
		nodeId: NODE_ID.orion,
		ip: "0.0.0.0",
		port: 27017,
		protocol: "tcp",
		serverId: "4d5e6f70-0004-4d00-8d00-000000027017",
		serverName: "Events Store",
	},
];
