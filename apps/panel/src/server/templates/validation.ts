...
/**
 * Server-side validation for the template authoring surface. The editor already
 ...
 * template can't be enormous, and rejects reserved env names — the same input
 ...
 * template's own current slug so a no-op rename keeps it.
 */
export function uniqueSlug(
	...
	const base = slugify(name) || "untitled-template";
