...
export const env = createEnv({
	server: {
		...
		DATABASE_URL: z.url(),
		// Redis connection string (redis:// or rediss://) — Better Auth secondary
		// storage (sessions + rate-limit counters). A plain TCP Redis; the panel
		// runs as a long-lived process. See src/server/redis.ts.
