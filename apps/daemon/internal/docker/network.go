...
const NetworkIDLabel = "cookiepanel.networkId"
...
type NetworkSpec struct {
	...
	Name      string // docker network name (daemon prefixes cookied-)
...
func (c *Client) CreateNetwork(ctx context.Context, spec NetworkSpec) (string, error) {
	...
	res, err := c.api.NetworkCreate(ctx, "cookied-"+spec.Name, opts)
	if err != nil {
